...
__global__ void ch8_in_scan_kernel(real* X, real* Y, int inputsize){
...
void ch8_in_scan(real* d_X, real* d_Y,int inputsize){
	ch8_in_scan_kernel<<<1,SECTION_SIZE/2>>>(d_X,d_Y,inputsize);
